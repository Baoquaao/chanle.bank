...
if ("undefined" != typeof Blob && ("undefined" == typeof FormData || !FormData.prototype.keys)) {
    const e = "object" == typeof globalThis ? globalThis : "object" == typeof window ? window : "object" == typeof self ? self : this
      , t = e.FormData
    ...
    try {
        ...
        e.File = function(e, t, n) {
            const o = new Blob(e,n)
              , a = n && void 0 !== n.lastModified ? new Date(n.lastModified) : new Date;
...
!function(t, e, n) {
    ...
    function D(t, e, n) {
        ...
        return {
            ...
            bottomLeftInner: L(r + n[3].width, i + v, Math.max(0, d - n[3].width), Math.max(0, f - n[2].width)).bottomLeft.subdivide(.5)
        }
    }
    function _(t, e, n, r) {
    ...
    T.prototype.getValue = function() {
        ...
        return t = "SELECT" === this.node.tagName ? C(this.node) : t,
    ...
    P.prototype.parseBackgroundClip = function(t, e, n, r, i) {
        ...
        default:
            ...
            W(s, r[2], r[3], e.bottomRightOuter, e.bottomLeftOuter, i.left + i.width, i.top + i.height),
